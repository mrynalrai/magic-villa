...
namespace MagicVilla.Villa.Api.Controllers
{
    ...
    public class VillasController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public ActionResult Create([FromBody] VillaCreateDto villaDto) 
        {
            if (villaDto == null) 
            {
                return BadRequest();
            ...
            */
            ...
            _dbContext.Villas.Add(model);   // EF will automatically add autogenerated Id to this model
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public IActionResult Update(int id, [FromBody]VillaUpdateDto villaDto)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public IActionResult UpdatePartial(int id, [FromBody]JsonPatchDocument<VillaUpdateDto> villaPatchDoc)
        {
